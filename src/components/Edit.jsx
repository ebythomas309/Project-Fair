        ...
        <Modal.Body>
          <div className="row align-items-center">
            ...
            <div className="col-lg-8">
              ...
              <div className="mb-2">
                <input value={projectDetails.languages} onChange={e => setProjectDetails({ ...projectDetails, languages: e.target.value })} type="text" placeholder='Project Languages' className="form-control" />
              </div>
              <div className="mb-2">
