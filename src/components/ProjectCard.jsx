...
const ProjectCard = ({displayData}) => {
  ...
  return (
    <>
     <Card onClick={handleShow} className='btn shadow'style={{ maxWidth: '350px', minHeight: '350px' }} >
        ...
        <Modal.Body>
          <div className="row">
            ...
            <div className="col-lg-6">
              ...
              <h6>Languages Used: <span className='text-danger' >{displayData?.languages}</span> </h6>
          ...
          <div className="mt-2 float-start">
            ...
            <a href={displayData?.website} target='_blank' className="btn btn-secondary ms-1"><i className="fa-solid fa-link"></i></a>
          </div>
        </Modal.Body>
      </Modal>
    </>
